    ...
    case BUTTON_ENC_ID:
        ...
        case BUTTON_SHORT_PRESS:
            ...
            case HMI_MENU_ID_CONSTANT_CURRENT:
                hmi_set_screen(HMI_ID_SCREEN_CONSTANT_CURRENT);
                break;
            case HMI_MENU_ID_CONSTANT_VOLTAGE:
                hmi_set_screen(HMI_ID_SCREEN_CONSTANT_VOLTAGE);
                break;
            case HMI_MENU_ID_CONSTANT_RESISTENCE:
                hmi_set_screen(HMI_ID_SCREEN_CONSTANT_RESISTENCE);
                break;
            case HMI_MENU_ID_DYNAMIC_MODE:
                hmi_set_screen(HMI_ID_SCREEN_DYNAMIC_MODE);
                break;
            case HMI_MENU_ID_PULSE_MODE:
                hmi_set_screen(HMI_ID_SCREEN_PULSE_MODE);
                break;
            case HMI_MENU_ID_SETTINGS:
                hmi_set_screen(HMI_ID_SCREEN_SETTINGS);
                break;
            default:
                break;
            }
