...
static void hmi_dashboard_show_target(void)
{
    ...
    char sz_string[20] = {0};
    snprintf(sz_string, sizeof(sz_string), "%u%u.%u%u%u %s",
...
static void hmi_dashboard_increment_field(void)
{
    ...
    {
        hmi_dashboard_ctrl.index_field =INDEX_FIVE_DIGIT;
    }
}
...
static void hmi_dashboard_increment_digit(void)
{
    ...
    if(hmi_edit[hmi_dashboard_ctrl.mode].value[INDEX_FIRST_DIGIT] >= 4)
    {
        hmi_edit[hmi_dashboard_ctrl.mode].value[INDEX_FIRST_DIGIT] = 4;  
...
void hmi_dashboard_show_screen(void)
{
    ...
    ST7789_WriteString(10, 3, hmi_dashboard_str[hmi_dashboard_ctrl.mode].tittle, Font_16x26, hmi_dashboard_str[hmi_dashboard_ctrl.mode].color, BLACK);
